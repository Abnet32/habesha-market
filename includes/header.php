...
<head>
    ...
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) . ' | Habesha Market' : 'Habesha Market — Ethiopian Online Marketplace'; ?></title>
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <li><a href="profile.php" class="<?= $current_page === 'profile.php' ? 'active' : '' ?>">
                <i class="fas fa-user"></i> <?= htmlspecialchars($_SESSION['full_name'] ?? 'Profile') ?></a></li>
            <li><a href="logout.php" class="nav-btn">
                <i class="fas fa-sign-out-alt"></i> <span>Logout</span></a></li>
        <?php else: ?>
            <li><a href="login.php" class="<?= $current_page === 'login.php' ? 'active' : '' ?>">
                <i class="fas fa-sign-in-alt"></i> Login</a></li>
            <li><a href="signup.php" class="nav-btn">
